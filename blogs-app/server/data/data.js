...
{name:'comments', data : [
  {'_id':'1', 'answer':'A framework for creating ambitous web applications', 'date':new Date(), 'post':'1', 'user': '3'},
  {'_id':'2', 'answer':'It really is!', 'date':new Date(), 'post':'1', 'user': '3'},
  {'_id':'3', 'answer':'Beside the lake, beneath the trees', 'date':new Date(), 'post':'2', 'user': '1'},
  {'_id':'4', 'answer':'Fluttering and dancing in the breeze', 'date':new Date(), 'post':'2', 'user': '1'},
  {'_id':'5', 'answer':'That floats on high o er vales and hills', 'date':new Date(), 'post':'3', 'user': '2'},
  {'_id':'6', 'answer':'Continuous as the stars that shine', 'date':new Date(), 'post':'3', 'user': '2'}
]}
];
