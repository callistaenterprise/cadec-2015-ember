data = [
  ...
  {name:'posts', data : [
  {'_id':'1', 'title':'Stephens Blog', 'body':'Ember Rocks!', 'userId':'1', 'comments':['10', '11']},
  {'_id':'2', 'title':'Jonases Blog', 'body':'A host, of golden daffodils', 'userId':'2', 'comments':['20', '21']},
  {'_id':'3', 'title':'Sedinas Blog', 'body':'I wandered lonely as a cloud', 'userId':'3', 'comments':['30', '31']}
]},

{name:'comments', data : [
  {'_id':'1', 'answer':'A framework for creating ambitous web applications', 'date':new Date(), 'postId':'1'},
  {'_id':'2', 'answer':'It really is!', 'date':new Date(), 'postId':'1'},
  {'_id':'3', 'answer':'Beside the lake, beneath the trees', 'date':new Date(), 'postId':'2'},
  {'_id':'4', 'answer':'Fluttering and dancing in the breeze', 'date':new Date(), 'postId':'2'},
  {'_id':'5', 'answer':'That floats on high o er vales and hills', 'date':new Date(), 'postId':'3'},
  {'_id':'6', 'answer':'Continuous as the stars that shine', 'date':new Date(), 'postId':'3'}
]}
];
