...
db.comments.insert([
  {'_id':'1', 'body':'A framework for creating ambitous web applications', 'date':new Date(), 'post':'1'},
  {'_id':'2', 'body':'It really is!', 'date':new Date(), 'post':'1'},
  {'_id':'3', 'body':'Beside the lake, beneath the trees', 'date':new Date(), 'post':'2'},
  {'_id':'4', 'body':'Fluttering and dancing in the breeze', 'date':new Date(), 'post':'2'},
  {'_id':'5', 'body':'That floats on high o er vales and hills', 'date':new Date(), 'post':'3'},
  {'_id':'6', 'body':'Continuous as the stars that shine', 'date':new Date(), 'post':'3'}
])*/
